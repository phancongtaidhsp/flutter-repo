...
class ConfigurableExpansionTileCustom extends StatefulWidget {
  ...
  const ConfigurableExpansionTileCustom(
      {Key? key,
...
class _ConfigurableExpansionTileState
    extends State<ConfigurableExpansionTileCustom>
